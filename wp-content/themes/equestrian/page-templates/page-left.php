...
<article>
	<div class="container page-content mobile-padding">
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-4"><?php if(function_exists('generated_dynamic_sidebar')) generated_dynamic_sidebar(); else dynamic_sidebar('sidebar_page'); ?></div>
			<div class="col-lg-7 col-md-8 col-sm-8 col-lg-offset-1">
